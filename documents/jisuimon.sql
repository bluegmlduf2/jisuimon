...
CREATE TABLE `comment_reply_table` (
  `comment_reply_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '대댓글id',
  `comment_reply_content` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '대댓글내용',
...
CREATE TABLE `comment_table` (
  `comment_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '댓글id',
  `comment_content` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '댓글내용',
  `comment_create_date` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '댓글등록날짜',
  `comment_update_date` datetime DEFAULT NULL,
  `user_table_user_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '댓글작성자id',
  `post_table_post_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '게시물id',
...
CREATE TABLE `ingredient_table` (
  `post_table_post_id` varchar(36) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `ingredient_id` int NOT NULL COMMENT 'food_id와 동일값',
  `ingredient_amt` int NOT NULL COMMENT '재료수량',
  `ingredient_unit` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '재료단위',
...
CREATE TABLE `post_detail_table` (
  ...
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '게시글내용 (2만자가량)',
...
CREATE TABLE `post_table` (
  ...
  `title_image` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '제목이미지',
